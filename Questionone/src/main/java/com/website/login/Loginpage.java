...
public class Loginpage {
    ...
    @FindBy(xpath="/html/body/app-root/app-main-page/app-header/div[1]/div/div/nav/div/div/ul/li[3]/ul/div[1]/li[1]/a/div/div/span")
    private WebElement MEAN_FullStack_button;
   ...
   // private WebElement Submit;
    ...
    public void click_MEAN_FullStackbutton(){
    	MEAN_FullStack_button.click();
    }
